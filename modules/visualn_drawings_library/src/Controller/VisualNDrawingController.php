...
namespace Drupal\visualn_drawings_library\Controller;
...
class VisualNDrawingController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\visualn_drawings_library\Entity\VisualNDrawingInterface $visualn_drawing
  ...
  public function revisionOverview(VisualNDrawingInterface $visualn_drawing) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\visualn_drawings_library\VisualNDrawingInterface $revision */
