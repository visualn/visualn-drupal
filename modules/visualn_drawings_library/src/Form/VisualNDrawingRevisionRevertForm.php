...
class VisualNDrawingRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\visualn_drawings_library\Entity\VisualNDrawingInterface
   */
  protected $revision;
   ...
   *
   * @param \Drupal\visualn_drawings_library\Entity\VisualNDrawingInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\visualn_drawings_library\Entity\VisualNDrawingInterface
