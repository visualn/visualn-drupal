...
class VisualNDataSetRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\visualn_data_sources\Entity\VisualNDataSetInterface
   */
  protected $revision;
   ...
   *
   * @param \Drupal\visualn_data_sources\Entity\VisualNDataSetInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\visualn_data_sources\Entity\VisualNDataSetInterface
